...
const TIMELINE_DATA = [
  {
    year: "2024 - Present",
    title: "B.Tech in Computer Science with specialization in Cybersecurity",
    org: "Amrita Vishwa Vidyapeetham",
    description: "I am currently pursuing my Bachelor of Technology (B.Tech), where I am applying my strong analytical foundation to master advanced core engineering concepts and modern computing technologies. This phase of my education focuses heavily on hands-on software development, practical problem-solving, and building real-world applications.",
    type: "education",
  },
  {
    year: "2022 - 2024",
    ...
    description: "Pursuing the MPC stream significantly enhanced my complex problem-solving abilities and logical reasoning and passed out with 95.5%.",
    type: "education",
  },
  {
    year: "2021 - 2022",
    ...
    description: "My secondary education laid a strong academic foundation for my journey and Completed my high school journey with 9.7 cgpa.",
    type: "education",
  },
];
