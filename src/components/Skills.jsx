...
const skills = [
  { category: "Frontend", items: ["React", "HTML","CSS", "JS", "Framer Motion"] },
  { category: "Backend", items: ["Node.js", "Express", "PostgreSQL"] },
  { category: "Other programming languages", items: ["Python", "C", "C++", "JAVA"] },
];
      ...
      <div className="max-w-7xl mx-auto relative">
        ...
        >
          <h2 className="text-5xl md:text-7xl font-bold text-white mb-6 tracking-tight">
            My <span className="text-transparent bg-clip-text bg-linear-to-r from-blue-400 to-purple-400">Tech Stack</span>
          </h2>
          <p className="text-gray-400 text-lg max-w-2xl leading-relaxed">
             Here is a list of the languages and frameworks I’m comfortable working with.
          </p>
        </motion.div>
